...
lib.ssMetadata = [
		{name:"CPCCO_WellChild_160x600_atlas_NP_1", frames: [[1806,0,320,1200],[0,0,600,1200],[602,0,600,1200],[1204,0,600,1200]]}
];
...
(lib.CO_WellChild_160x6002 = function() {
	this.initialize(ss["CPCCO_WellChild_160x600_atlas_NP_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.CPCCO_WellChild_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(-30.8,299.5,267.9,327.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CPCCO_WellChild_160x600_atlas_NP_1.jpg?1651020616835", id:"CPCCO_WellChild_160x600_atlas_NP_1"}
	],
	preloads: []
};
