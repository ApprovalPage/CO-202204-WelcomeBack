...
lib.ssMetadata = [
		{name:"JCC_Diabetes_160x600_atlas_NP_1", frames: [[0,0,612,408],[511,820,508,339],[0,410,612,408],[0,820,509,339]]}
];
...
(lib.gettyimages1220083252612x612 = function() {
	this.initialize(ss["JCC_Diabetes_160x600_atlas_NP_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.JCC_Diabetes_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_5.setTransform(80.1,419.1,1.0017,2.2694,0,0,0,0.1,67);
...
p.nominalBounds = new cjs.Rectangle(-51.8,257,400.7,364);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/JCC_Diabetes_160x600_atlas_NP_1.jpg?1651008003272", id:"JCC_Diabetes_160x600_atlas_NP_1"}
	],
	preloads: []
};
