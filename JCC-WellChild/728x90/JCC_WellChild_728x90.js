...
lib.ssMetadata = [
		{name:"JCC_WellChild_728x90_atlas_NP_1", frames: [[0,0,600,500],[0,502,600,500],[0,1004,600,500],[0,1506,600,500]]}
];
...
(lib.CO_WellChild_300x2501 = function() {
	this.initialize(ss["JCC_WellChild_728x90_atlas_NP_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.JCC_WellChild_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/JCC_WellChild_728x90_atlas_NP_1.jpg?1651019458192", id:"JCC_WellChild_728x90_atlas_NP_1"}
	],
	preloads: []
};
