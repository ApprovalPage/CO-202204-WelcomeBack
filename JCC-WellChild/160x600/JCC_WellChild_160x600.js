...
lib.ssMetadata = [
		{name:"JCC_WellChild_160x600_atlas_NP_1", frames: [[1806,0,320,1200],[0,0,600,1200],[602,0,600,1200],[1204,0,600,1200]]}
];
...
(lib.CO_WellChild_160x6002 = function() {
	this.initialize(ss["JCC_WellChild_160x600_atlas_NP_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.JCC_WellChild_160x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/JCC_WellChild_160x600_atlas_NP_1.jpg?1651019563293", id:"JCC_WellChild_160x600_atlas_NP_1"}
	],
	preloads: []
};
